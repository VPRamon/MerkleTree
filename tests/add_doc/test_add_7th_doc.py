...
from tests.build_tree.test_7_docs_test import validate_7_docs_mtree
...
def test_add_7th_doc(setup_test):
    ...
    NEW_DOC_6 = bytes((PREFIX_DOC+'hello 6').encode('utf-8'))

    docs = [DOC_0,DOC_1,DOC_2,DOC_3,DOC_4,DOC_5,NEW_DOC_6]

    # Validate subtree (docs from 0 to 5)
    validate_6_docs_mtree(docs[:6], mtree)

    # Create new doc
    mtree.addDocument("documents",'hello 6')

    # Validate subtree (docs from 0 to 3)
    validate_7_docs_mtree(docs, mtree)
